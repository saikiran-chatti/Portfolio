    ...
    return (
        <div className="projectsContainer">
            ...
            <div className="projects">
                ...
                <a href="https://nowires.netlify.app/" target="_blank" rel="noreferrer" className="linkProject" >
                ...
                {/* <a href="https://play.google.com/store/apps/details?id=com.gfeed.sudhaseshu.gitamfeed"
                    rel="noreferrer" target="_blank"> */}
                <a href="https://play.google.com/store/apps/details?id=com.gfeed.sudhaseshu.gitamfeed" target="_blank" rel="noreferrer" className="linkProject" >
                    <div className="projectCard">
